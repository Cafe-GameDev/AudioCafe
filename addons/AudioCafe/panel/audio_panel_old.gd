...
# 		var loaded_manifest = ResourceLoader.load(MANIFEST_SAVE_PATH, "", ResourceLoader.CacheMode.CACHE_MODE_REPLACE) # Usar CACHE_MODE_REPLACE para recarregar sem cache
...
# 	_validate_path_line_edit(line_edit, is_sfx)
...
# func _validate_path_line_edit(line_edit: LineEdit, is_sfx: bool):
# 	var is_valid = true
# 	var error_message = ""
